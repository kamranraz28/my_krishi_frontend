<template>
  <div class="page-wrapper">
    ...
    <section class="page-header">
      ...
      <div class="container">
        <h2 class="page-header__title bw-split-in-down">Our Team</h2>
        ...
        <div class="row gutter-y-30">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              ...
              <div class="team-card__content">
                ...
                <!-- /.team-card__title -->
                <p class="team-card__designation">Farmar</p>
                <!-- /.team-card__designation -->
              </div>
              <!-- /.team-card__content -->
              <div class="team-card__social">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              ...
              <div class="team-card__content">
                <h3 class="team-card__title">
                  <a href="team-details.html">Joshua Settles</a>
                </h3>
                <!-- /.team-card__title -->
                <p class="team-card__designation">Farmar</p>
                <!-- /.team-card__designation -->
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              ...
              <div class="team-card__content">
                <h3 class="team-card__title">
                  <a href="team-details.html">Alice Cardoza</a>
                </h3>
                <!-- /.team-card__title -->
                <p class="team-card__designation">Gardener</p>
                <!-- /.team-card__designation -->
              </div>
              <!-- /.team-card__content -->
              <div class="team-card__social">
          ...
          <div class="col-md-6 col-lg-4">
            ...
            >
              <div class="team-card__image">
                <img src="/assets/images/team/team-1-6.jpg" alt="Steven Boyd" />
              </div>
              <!-- /.team-card__image -->
              <div class="team-card__content">
                <h3 class="team-card__title">
                  <a href="team-details.html">Steven Boyd</a>
                </h3>
                <!-- /.team-card__title -->
                <p class="team-card__designation">Farmar</p>
                <!-- /.team-card__designation -->
