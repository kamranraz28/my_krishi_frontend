            ...
            <div class="row-table">
              <div class="col-sm-6 card-body br">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-eye text-c-green mb-1 d-block"
                    ></i>
                  </div>
              ...
              <div class="col-sm-6 card-body">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-music text-c-red mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>100%</h5>
            ...
            <div class="row-table">
              <div class="col-sm-6 card-body br">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-file-text text-c-blue mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>2000 +</h5>
              ...
              <div class="col-sm-6 card-body">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-mail text-c-yellow mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>120</h5>
            ...
            <div class="row-table">
              <div class="col-sm-6 card-body br">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-share-2 text-c-blue mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>1000</h5>
              ...
              <div class="col-sm-6 card-body">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-wifi text-c-blue mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>600</h5>
            ...
            <div class="row-table">
              <div class="col-sm-6 card-body br">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-rotate-ccw text-c-blue mb-1 d-block"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>3550</h5>
              ...
              <div class="col-sm-6 card-body">
                <div class="row">
                  <div class="col-sm-4">
                    <i
                      class="icon feather icon-shopping-cart text-c-blue mb-1 d-blockz"
                    ></i>
                  </div>
                  <div class="col-sm-8 text-md-center">
                    <h5>100%</h5>
                ...
                <div class="btn-group card-option">
                  ...
                  >
                    <li class="dropdown-item full-card">
                      <a href="#!"
                        ><span
                          ><i class="feather icon-maximize"></i> maximize</span
                  ...
                  <tbody>
                    <tr>
                      <td>
                        ...
                        <div class="d-inline-block align-middle">
                          <img
                            src="/asset/images/user/avatar-4.jpg"
                            alt="user image"
                    ...
                    <tr>
                      <td>
                        ...
                        <div class="d-inline-block align-middle">
                          <img
                            src="/asset/images/user/avatar-3.jpg"
                            alt="user image"
                            class="img-radius wid-40 align-top m-r-15"
                          />
                          <div class="d-inline-block">
              ...
              <div class="latest-update-box">
                ...
                <div class="row p-b-0">
                  <div class="col-auto text-right update-meta">
                    ...
                    <i
                      class="feather icon-facebook bg-facebook update-icon"
                    ></i>
                  </div>
                  <div class="col">
                    <a href="#!">
            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-6">
                  ...
                  <h6 class="text-muted m-b-0">
                    Bounce Rate<i
                      class="fa fa-caret-up text-c-green m-l-10"
                    ></i>
                  </h6>
                </div>
                <div class="col-6">
              ...
              <div class="review-block">
                <div class="row">
                  ...
                  <div class="col">
                    <h6 class="m-b-15">
                      John Deo
                      <span class="float-right f-13 text-muted">
                        a week ago</span
                      >
                    </h6>
                    <a href="#!"
                    ...
                    <a href="#!" class="m-r-30 text-muted"
                      ><i class="feather icon-thumbs-up m-r-15"></i>Helpful?</a
                    >
                    <a href="#!"
            ...
            <div class="card-body">
              ...
              <div class="row m-b-20 received-chat">
                ...
                <div class="col">
                  <div class="msg">
                    <p class="m-b-0">Nice to meet you!</p>
                    <img src="/asset/images/widget/dashborad-1.jpg" alt="" />
                    <img src="/asset/images/widget/dashborad-3.jpg" alt="" />
                  </div>
                  <p class="text-muted m-b-0">
                    <i class="fa fa-clock-o m-r-10"></i>10:20am
                  </p>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="text-c-green f-w-500">
                <i class="fa fa-caret-up m-r-15"></i> 18% High than last month
              </p>
              <div class="row">
